...
public class AdminMainFrm extends javax.swing.JFrame {
    ...
    private void loadMoviesToTable() {
        ...
        for (Movie movie : movies) {
            String runtime = movie.getHour() + " h and " + movie.getMinute() + " m";
    ...
    private void initComponents() {
        ...
        manageMoviesBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/managemoviesBtnHover.png"))); // NOI18N
        ...
        refreshBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/refreshBtn.png"))); // NOI18N
    ...
    private void getManageMovies() throws SQLException{
        ...
        try{
            ResultSet rs;
            try (PreparedStatement pst = DatabaseConnection.getConnection().prepareStatement(getMoviesQuery)) {
                rs = pst.executeQuery();
                while(rs.next())
                {
                    int id = rs.getInt("id");
